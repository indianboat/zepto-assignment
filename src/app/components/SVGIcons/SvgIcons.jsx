  ...
  return (
    ...
    >
      ...
      <defs>
        ...
        >
          <stop stopColor="#FF3269" />
          <stop offset={1} stopColor="#FF794D" />
        </linearGradient>
      </defs>
    </svg>
...
const MoonIcon = ({ width = 24, height = 24, className = "flex-shrink-0 w-4 h-4" }) => {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
const SunIcon = ({ width = 24, height = 24, className = "flex-shrink-0 w-4 h-4" }) => {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export { GithubIcon, ZeptoLogo, MoonIcon, SunIcon, LinkedInIcon}